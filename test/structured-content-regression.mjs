...
console.log(`${BLUE}🧪 IEDB Structured Content Regression Tests${RESET}`);

const toolExpectations = [
  {
    path: 'src/tools/predict-mhci.ts',
    required: ['createCodeModeResponse', 'createCodeModeError'],
  },
  {
    path: 'src/tools/predict-mhcii.ts',
    required: ['createCodeModeResponse', 'createCodeModeError'],
  },
  {
    path: 'src/tools/predict-bcell.ts',
    required: ['createCodeModeResponse', 'createCodeModeError'],
  },
  {
    path: 'src/tools/predict-processing.ts',
    required: ['createCodeModeResponse', 'createCodeModeError'],
  },
];
...
assertContains('src/index.ts', indexContent, 'IedbDataDO', 'index.ts exports IedbDataDO');
...
console.log(`\n${GREEN}✅ IEDB structured content regression tests passed.${RESET}`);
